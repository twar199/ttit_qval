...
# Создание dummy0 интерфейса с адресом 3.3.3.3/32
...
vtysh -c 'conf t' -c 'router ospf' -c 'ospf router-id 3.3.3.3' -c 'network 192.168.20.0/28 area 3' -c 'network 10.0.20.0/30 area 0' -c 'exit' -c 'exit' -c 'write'
