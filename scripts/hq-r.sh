...
# Создание dummy0 интерфейса с адресом 1.1.1.1/32
...
vtysh -c 'conf t' -c 'router ospf' -c 'ospf router-id 1.1.1.1' -c 'network 192.168.10.0/26 area 1' -c 'network 10.0.10.0/30 area 0' -c 'exit' -c 'exit' -c 'write'
